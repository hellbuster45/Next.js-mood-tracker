...
export default function Login() {
  return (
    <div className = {'flex flex-col flex-1 justify-center gap-4 place-items-center w-full '}>
      ...
      <input className= {'bg-black w-full max-w-[275px] border border-3 mx-auto px-3 py-2 sm:py-3 hover:border-blue-400 focus:border-blue-600 rounded-full outline-none '} placeholder='E-mail ' />
      <input className= {'bg-black w-full max-w-[275px] border border-3 mx-auto px-3 py-2 sm:py-3 hover:border-blue-400 focus:border-blue-600 rounded-full outline-none '} placeholder='Password ' type='Password' />
